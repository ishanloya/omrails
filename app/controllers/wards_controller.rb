class WardsController < ApplicationController
  ...
  def import
    Ward.import(params[:file])
    redirect_to wards_path, notice: "Ward data imported"
  end
  ...
  private
    ...
    def ward_params
      params.require(:ward).permit(:zone, :ward_number, :ward_name, :ward_officer, 
        ...
        :pvt_labour_male, :pvt_labour_female, :v_haathgadi, :v_cyclericks, :v_hydraulicauto, 
        :v_loadingauto, :v_tractor, :v_407, :hook_loader, :skip_loader, :households, 
        :comm_est, :edu_est, :med_est, :waste_org, :waste_dry, :waste_org_qty, 
        :waste_dry_qty, :waste_haz_qty)
    end
end
